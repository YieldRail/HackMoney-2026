...
contract DepositRouter is EIP712, ReentrancyGuard {
    ...
    /**
     * @notice Create and execute deposit in a single transaction (Lagoon vaults)
     */
    ...
    /**
     * @notice Cross-chain deposit via LI.FI - tokens already sent to contract (Lagoon vaults)
     */
