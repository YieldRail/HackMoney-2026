...
export const VAULTS_CONFIG: VaultConfig[] = [
  ...
  },
  {
    ...
    depositRouter: process.env.NEXT_PUBLIC_ETHEREUM_DEPOSIT_ROUTER_ADDRESS || '0x5A1E1cCe3c0f823255a688697A90885245b0043F',
    hasSettlement: true,
    type: 'lagoon',
  },
  {
  ...
  },
  {
    ...
    depositRouter: process.env.NEXT_PUBLIC_ARBITRUM_DEPOSIT_ROUTER_ADDRESS || '0x33e5D432Ae79F43dBD490d63553057b0BB3B594C',
    hasSettlement: false,
    type: 'morpho-v2',
  },
];
